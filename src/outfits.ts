    ...
    Outfit.doYourBest(
        {
            ...
            pants: $items`Great Wolf's beastly trousers, pantogram pants, Cargo Cultist Shorts`,
            acc1: $item`Beach Comb`,
            acc2: $item`Brutal brogues`,
    ...
    Outfit.doYourBest(
        {
            ...
            pants: $items`Great Wolf's beastly trousers`,
            acc1: $item`Brutal brogues`,
    ...
    Outfit.doYourBest(
        {
            ...
            weapon: $items`Staff of the Deepest Freeze, weeping willow wand`,
            offhand: $items`wrench, weeping willow wand`,
            familiar: famEquip,
            pants: $items`pantogram pants, Cargo Cultist Shorts`,
