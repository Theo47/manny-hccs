...
function ascend(path, playerClass, lifestyle, moon) {
  var consumable = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : $item(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral six-pack"])));
  ...
  if (consumable && !$items(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable)) {
    throw new Error("Invalid consumable ".concat(consumable));
  }

  if (pet && !$items(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet)) {
...
var Path_templateObject, Path_templateObject2, Path_templateObject3, Path_templateObject4, Path_templateObject5, Path_templateObject6, _templateObject7, _templateObject8, _templateObject9, _templateObject10, _templateObject11;
...
var Paths = {
  ...
  AvatarOfWestOfLoathing: new Path("Avatar of West of Loathing", 26, false, true, true, 10, 10, 10, $classes(_templateObject7 || (_templateObject7 = Path_taggedTemplateLiteral(["Cow Puncher, Snake Oiler, Beanslinger"])))),
  TheSource: new Path("The Source", 27),
  NuclearAutumn: new Path("Nuclear Autumn", 28, false, false, true, 3, 3, 3),
  GelatinousNoob: new Path("Gelatinous Noob", 29, false, true, true, 0, 0, 0, $classes(_templateObject8 || (_templateObject8 = Path_taggedTemplateLiteral(["Gelatinous Noob"])))),
  ...
  DarkGyffte: new Path("Dark Gyffte", 35, false, true, false, 5, 5, 15, $classes(_templateObject9 || (_templateObject9 = Path_taggedTemplateLiteral(["Vampyre"])))),
  TwoCrazyRandomSummer: new Path("Two Crazy Random Summer", 36),
  KingdomOfExploathing: new Path("Kingdom of Exploathing", 37),
  PathOfThePlumber: new Path("Path of the Plumber", 38, false, true, true, 20, 0, 5, $classes(_templateObject10 || (_templateObject10 = Path_taggedTemplateLiteral(["Plumber"])))),
  ...
  $classes(_templateObject11 || (_templateObject11 = Path_taggedTemplateLiteral(["Grey Goo"]))))
};
;// CONCATENATED MODULE: ./src/hccsAscend.ts
var hccsAscend_templateObject, hccsAscend_templateObject2, hccsAscend_templateObject3;

function hccsAscend_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
(0,external_kolmafia_namespaceObject.print)("you're about to ascend! wait, is that good?", "green");
...
ascend(Paths.CommunityService, $class(hccsAscend_templateObject || (hccsAscend_templateObject = hccsAscend_taggedTemplateLiteral(["Sauceror"]))), Lifestyle.hardcore, "blender", $item(hccsAscend_templateObject2 || (hccsAscend_templateObject2 = hccsAscend_taggedTemplateLiteral(["astral six-pack"]))), $item(hccsAscend_templateObject3 || (hccsAscend_templateObject3 = hccsAscend_taggedTemplateLiteral(["astral statuette"]))));
})();
