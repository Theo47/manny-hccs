...
var hccsAscend_templateObject, hccsAscend_templateObject2, hccsAscend_templateObject3, hccsAscend_templateObject4, hccsAscend_templateObject5, hccsAscend_templateObject6, hccsAscend_templateObject7;
...
prepareAscension({
  ...
  eudora: template_string_$item(hccsAscend_templateObject || (hccsAscend_templateObject = hccsAscend_taggedTemplateLiteral(["Our Daily Candles\u2122 order form"])))
}, {
  desk: template_string_$item(hccsAscend_templateObject2 || (hccsAscend_templateObject2 = hccsAscend_taggedTemplateLiteral(["Swiss piggy bank"]))),
  nightstand: template_string_$item(hccsAscend_templateObject3 || (hccsAscend_templateObject3 = hccsAscend_taggedTemplateLiteral(["foreign language tapes"]))),
  ceiling: template_string_$item(hccsAscend_templateObject4 || (hccsAscend_templateObject4 = hccsAscend_taggedTemplateLiteral(["ceiling fan"])))
});
ascend(Paths.CommunityService, template_string_$class(hccsAscend_templateObject5 || (hccsAscend_templateObject5 = hccsAscend_taggedTemplateLiteral(["Sauceror"]))), Lifestyle.hardcore, "blender", template_string_$item(hccsAscend_templateObject6 || (hccsAscend_templateObject6 = hccsAscend_taggedTemplateLiteral(["astral six-pack"]))), template_string_$item(hccsAscend_templateObject7 || (hccsAscend_templateObject7 = hccsAscend_taggedTemplateLiteral(["astral statuette"]))));
})();
